	...
	def __init__(self,self_ventana_principal):
		...
		if response == gtk.RESPONSE_OK:
			...
			if sys.platform == "linux2":
				...
				os.mkdir(carpeta)
				ruta=os.getcwd()
				shutil.copyfile(ruta+'/Base_Datos/stock_rosarino.db',carpeta+"/stock_rosarino.db")
				shutil.copyfile(ruta+'/Base_Datos/marcas_rosarinas.db',carpeta+"/marcas_rosarinas.db")
