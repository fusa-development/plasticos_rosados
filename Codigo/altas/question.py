...
class question():
	...
	def cargar_lista(self,self_altas):
		...
		rubro = [self_altas.combobox.get_active_text().lower()]
		cursor=bbdd.cursor()
	...
	def cargar_again(self,widget,self_altas):
		...
		self_altas.entry_nro_art.set_text("")
		...
		self_altas.entry_nro_art.set_property("secondary-icon-stock",None)
		...
		self_altas.entry_marca.set_property("is-focus",1)
		self.window.destroy()
